class ApiConstants {
  ...
  static const String baseUrl = "https://46bb-105-36-171-216.ngrok-free.app/api/"; // todo
  ...
  static String sahbStore(int storeId, num tons) => 'app/store/trashed/$storeId/$tons';
